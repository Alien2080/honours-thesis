...
%Software Engineering Masters Thesis
%Tom Aylen 
...
\keywords{home computer, 8-bit, retro computer, MEGA65, FPGA} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
