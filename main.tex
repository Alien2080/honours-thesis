...
\usepackage{menukeys}
\usepackage{csquotes}
%\usepackage{natbib} %use for plainnat (author date) bibtex style


%----------------------------------------------------------------------------------------
%	ALT BIBTEX SETUP (remove other setup from end on document if used)
%----------------------------------------------------------------------------------------
...
\keywords{home computer, 8-bit, retro computer, MEGA65} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
at Flinders University - Adelaide, Australia} \\[3cm] %University requirement text
