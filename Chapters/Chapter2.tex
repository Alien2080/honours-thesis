...
\cite{RN34}. Many people were having their first interactions with computers, as the home computer became more widespread.
...
\begin{figure} \begin{center}
\includegraphics[width=1\linewidth]{pics/moore_law_crop} 
\end{center} 
...
\subsection{History of operating system complexity}
...
\begin{figure} \begin{center}
\includegraphics[width=0.8\linewidth]{pics/SLOC_linux_crop} 
\end{center} 
...
\cite{RN76}. This was not always the case. It seems the inevitable fate of any successful new technology that it will be manipulated by malicious actors. 
...
\textbf{Worm:} Similar to a virus in that it is a self-reproducing program, the difference comes from a worms ability to execute by itself, whereas a virus has to attach to another piece of software. Another way worms are similar to viruses is that now they are almost always malware but they first appeared as beneficial programs \cite{RN93}.
...
\textbf{Ransomware:} Also known as a cryptovirus or a cryptoworm. It is another type of malware which encrypts sensitive information and demands payment from the victim to decrypt the data \cite{RN165}. Payment is normally asked for in a form of cryptocurrency, such as Bitcoin, because it is much harder to trace.
\\
...
\cite{RN90}. There were numerous other worms and viruses created around the same time. These early incidents raised awareness of malware and computer security.
...
There are many, many, many more examples of malware and computer security issues, with more happening each day. Its worth noting that there has been a trend of malware being used more frequently to steal money, the first malware seemed to have been created out of curiosity and now more often than not malware is being used to steal money or valuable information which can be sold to other criminals. The WannaCry ransomware being a salient recent example of modern malware being created to steal money 
\cite{RN94}. 
...
The Brain virus exploited vulnerability found in the MS-DOS operating system, which was new at the time \cite{RN86}. The Morris worm exploited weak passwords as well as vulnerability with in Unix's sendmail, fingerd and rsh/rexec commands 
\cite{RN86}. 
