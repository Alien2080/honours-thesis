...
\cite{RN117}. The Vega+ has a microcontroller controller at its core which provides the computational power 
\cite{RN143}.
...
\subsection{C64 DTV}
\textbf{What is it?}\\
A single-chip Commodore 64 clone housed within a joystick, comes preloaded with 30 games. It was, unsurprisingly from the name, inspired by the Commodore 64. It features an ASIC (Application-specific Integrated Circuit) at its core 
